...
public class Rendimiento extends JFrame {
	...
	public Rendimiento() {
		...
		JLabel lblNewLabel_3 = new JLabel("Rendimiento Individual: " + "numerito" + "%");
		lblNewLabel_3.setFont(new Font("Verdana", Font.BOLD, 14));
		lblNewLabel_3.setBounds(76, 55, 318, 24);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_3_1 = new JLabel("Rendimiento Grupal: " + "numerito" + "%");
		...
		JLabel lblNewLabel_3_1_1 = new JLabel("Rendimiento Final: " + "numerito" + "%");
